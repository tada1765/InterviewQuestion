...
a. How to copy a list into another new list
...
def demo(meetings):
    li = meetings.copy()
    if not li:
        print("li list is empty.")
    
    earliest = findearliest(meetings)
    x = meetings[earliest]
    li.remove(x)
    return li
...
**result: is will not affect original list **

```

[(20, 30), (21, 25), (15, 40), (35, 40), (25, 60)]
[(10, 20), (20, 30), (21, 25), (15, 40), (35, 40), (25, 60)]

```

b. How to remove an element from a list by index?

detail application on a. How to copy a list into another new list
...
3
0
3 meeting room needed.
[(10, 20), (9, 55), (20, 30), (15, 40)]
