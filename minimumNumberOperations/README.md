...
using tree data-structure to present the data.
...
```
  ...
  reach x == y stop find min path and count,N=?
...
# thing needed before done anything:
1. element insert in tree
------------------------
...
2. get the level of a node in tree
-----------------------------------
...
# CODE from Other seem wrong result: [link](https://www.geeksforgeeks.org/minimum-number-operation-required-convert-number-x-y/)
